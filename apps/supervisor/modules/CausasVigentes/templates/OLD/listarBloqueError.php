...
<div class="grid-12-12 ui-widget-header ui-corner-all" style="position: relative;">Formulario FCRIMINOMETRICA</div>
<div class="clear"></div>
<div class="grid-12-12>
<div id="homeAlertMensaje" class="ui-widget">
          <div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em;">
            <p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 0.3em;"></span>
            <strong>¡ERROR!</strong> Este instrumento ya fué cerrado (<?php echo $datocierre; ?>)
          </div>
  </div>
</div>
<br>
