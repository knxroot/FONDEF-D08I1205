...
<?php $url_next_post=url_for('CACSA/proximoBloque?idEncuestado='.$idEncuestado);?>
  ...
  <div id="CACSA_pregunta_<?php echo $pregunta["id_pregunta"];?>" class="CACSA_bloque_pregunta">
    ...
    <div class="grid-2-12">
      <ul class="form-list-rdo">
        <li><input class="botonradio" id="<?php echo $pregunta["id_pregunta"];?>" name="radio_VorF_CACSA_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="si" Onclick="mostrar(<?php echo $pregunta["id_pregunta"];?>)"/><label class="form-lbl">Si</label></li>
        <li><input class="botonradio" id="<?php echo $pregunta["id_pregunta"];?>" name="radio_VorF_CACSA_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="no" Onclick="mostrar(<?php echo $pregunta["id_pregunta"];?>)"/><label class="form-lbl">No</label></li>
			</ul>
       ...
       <div id="respuesta2" class="grid-3-12" >
        ...
        <div  style="width: 50px;display: inline;float: left;height: 100%;margin-left: 1%;margin-right: 1%;padding: 0.5% 0.5% 0.8%;" >
                     ...
                     <ul>
                        <select type="checkbox" name="respuesta2_CACSA_<?php echo $pregunta["id_pregunta"];?>">
		...
		<div style="width: 100px;display: inline;float: left;height: 100%;margin-left: 1%;margin-right: 1%;padding: 0.5% 0.5% 0.8%;">
                    <ul class="form-list-rdo">
                        <li><input class="botonradio" name="radio_respuesta3_CACSA_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="si" /><label class="form-lbl3">Si</label></li>
                        <li><input class="botonradio" name="radio_respuesta3_CACSA_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="no" checked /><label class="form-lbl3">No</label></li>
                    </ul>
