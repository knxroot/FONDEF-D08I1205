...
<form id="formulario_SQIFA" name="formulario_SQIFA" class="form" method="post" action="<?php echo $url_next_post; ?>">
  ...
  <?php if ($bloque_valor==1){
            ...
            echo 'Sección B. Más preguntas que debe contestar el adolescente(Respuestas tipo Si/No)';
         }
         else if ($bloque_valor==3){
             echo 'Las siguientes preguntas se basan en sus observaciones y otra información que haya obtenido de un profesor / padres / persona que conozco bien al adolescente.';
         }  ?>
      </h1>
  </br>
