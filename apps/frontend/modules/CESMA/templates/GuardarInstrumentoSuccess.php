...
<a class="form-button form-left" style="display: block;" href="<?php echo url_for('CESMA/index?idEncuestado='.$idEncuestado);?>"><span class="ui-icon ui-icon-pencil" style="float:left;"></span>Continuar editando instrumento CESMA</a>
</div>
