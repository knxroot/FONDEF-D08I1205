  ...
  <div id="CACSA_pregunta_<?php echo $pregunta["id_pregunta"];?>" class="CACSA_bloque_pregunta">
    ...
    <div class="grid-4-12">
      <ul class="form-list-rdo">
        <li><input class="botonradio" id="<?php echo $pregunta["id_pregunta"];?>" name="radio_VorF_CACSA_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="V" Onclick="mostrar(<?php echo $pregunta["id_pregunta"];?>)"/><label class="form-lbl">Verdadero</label></li>
        <li><input class="botonradio" id="<?php echo $pregunta["id_pregunta"];?>" name="radio_VorF_CACSA_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="F" Onclick="mostrar(<?php echo $pregunta["id_pregunta"];?>)"/><label class="form-lbl">Falso</label></li>
			</ul>
