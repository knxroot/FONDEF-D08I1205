<?php slot('title') ?>
  <?php  echo "Formulario CICUM-PARTE2 ({$porcCompletado} % completado)";?>
<?php end_slot(); ?>

<?php $url_next_post=url_for('CAIE/proximoBloque2?idEncuestado='.$idEncuestado);?>
...
<!-- Comienzo Bloque Dialogo Instrucciones -->
  <div id="dialogo-instrucciones" style="display: none;" title="Instrucciones (CICUM)">
    ...
    A continuación te presentamos doce frases para conocer tu opinión. Debes responder señalando tu grado de acuerdo con cada frase, pensando siempre en el grupo étnico con que te has identificado. Una vez que decidas tu grado de acuerdo con cada frase selecciona la alternativa elegida
   <br><br>
   Por ejemplo respecto de la siguiente frase: "Últimamente me he dedicado a conocer más sobre la historia, tradiciones y costumbres de mi grupo étnico" <br>

    <li>Si lo has experimentado con mucho interés o frecuencia, selecciona <b>Muy de Acuerdo</b></li>
    <li>Si lo has experimentado, pero muy poco, selecciona <b>De Acuerdo</b></li>
    <li>Si NO lo has experimentado, pero podrías hacerlo, selecciona <b>En Desacuerdo</b></li>
    <li>Si NO lo has experimentado y no te interesa hacerlo, selecciona <b>Muy en Desacuerdo</b></li>
...
<form id="formulario_CAIE" name="formulario_CAIE" class="form" method="post" action="<?php echo $url_next_post; ?>">
  ...
  <div class="grid-12-12 ui-widget-header ui-corner-all" style="position: relative;">Formulario CICUM PARTE2- <?php echo $porcCompletado; ?> % completado
  ...
  <div id="CAIE_pregunta_<?php echo $pregunta["id_pregunta"];?>" class="CAIE_bloque_pregunta">
    ...
    <div class="grid-7-12">
      <ul class="form-list-rdo">
        <li><input class="botonradio" name="radio_VorF_CAIE_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="Muy de Acuerdo" /><label class="form-lbl">Muy de Acuerdo</label></li>
        <li><input class="botonradio" name="radio_VorF_CAIE_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="De Acuerdo" /><label class="form-lbl">De Acuerdo</label></li>
        <li><input class="botonradio" name="radio_VorF_CAIE_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="En Desacuerdo" /><label class="form-lbl">En Desacuerdo</label></li>
        <li><input class="botonradio" name="radio_VorF_CAIE_<?php echo $pregunta["id_pregunta"];?>" type="radio" value="Muy en Desacuerdo" /><label class="form-lbl">Muy en Desacuerdo</label></li>
			</ul>
    </div>
