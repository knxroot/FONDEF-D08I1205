...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('CausasActuales/edit?id='.$encuestado_actinputado->getId()) ?>"><?php echo $encuestado_actinputado->getId() ?></a></td>
  ...
  <a href="<?php echo url_for('CausasActuales/new') ?>">New</a>
