...
<a class="form-button form-left" style="display: block;" href="<?php echo url_for('EDA/index?idEncuestado='.$idEncuestado);?>"><span class="ui-icon ui-icon-pencil" style="float:left;"></span>Continuar editando instrumento EDA</a>
</div>
