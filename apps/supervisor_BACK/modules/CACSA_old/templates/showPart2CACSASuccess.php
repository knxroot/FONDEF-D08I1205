  ...
  <div id="CACSA_pregunta_<?php echo $pregunta["id_pregunta"];?>" class="CACSA_bloque_pregunta">
    ...
    <div class="grid-2-12">
      ...
      <ul class="form-list-rdo">
           <select type="checkbox" id="<?php echo $pregunta["id_pregunta"];?>"  name="radio_VorF_CACSA_<?php echo $pregunta["id_pregunta"];?>" Onclick="mostrar(<?php echo $pregunta["id_pregunta"];?>)" >
                               <OPTION VALUE="0" Onclick="mostrar(<?php echo $pregunta["id_pregunta"];?>)">0 - Ninguna</OPTION>
