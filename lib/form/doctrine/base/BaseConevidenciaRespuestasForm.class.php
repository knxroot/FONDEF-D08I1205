...
/**
 * ConevidenciaRespuestas form base class.
 *
 * @method ConevidenciaRespuestas getObject() Returns the current form's model object
 *
 * @package    psicologia
 * @subpackage form
 ...
 */
abstract class BaseConevidenciaRespuestasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('conevidencia_respuestas[%s]');
