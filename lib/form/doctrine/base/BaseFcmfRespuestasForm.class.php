...
/**
 * FcmfRespuestas form base class.
 *
 * @method FcmfRespuestas getObject() Returns the current form's model object
 *
 * @package    psicologia
 * @subpackage form
 ...
 */
abstract class BaseFcmfRespuestasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fcmf_respuestas[%s]');
