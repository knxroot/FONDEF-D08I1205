...
/**
 * Conclusiones form base class.
 *
 * @method Conclusiones getObject() Returns the current form's model object
 *
 * @package    psicologia
 * @subpackage form
 ...
 */
abstract class BaseConclusionesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('conclusiones[%s]');
