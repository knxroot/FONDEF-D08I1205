...
/**
 * IrncRespuestas form base class.
 *
 * @method IrncRespuestas getObject() Returns the current form's model object
 *
 * @package    psicologia
 * @subpackage form
 ...
 */
abstract class BaseIrncRespuestasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('irnc_respuestas[%s]');
