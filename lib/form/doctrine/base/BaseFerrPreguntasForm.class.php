...
/**
 * FerrPreguntas form base class.
 *
 * @method FerrPreguntas getObject() Returns the current form's model object
 *
 * @package    psicologia
 * @subpackage form
 ...
 */
abstract class BaseFerrPreguntasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ferr_preguntas[%s]');
