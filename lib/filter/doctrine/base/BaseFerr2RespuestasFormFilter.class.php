...
/**
 * Ferr2Respuestas filter form base class.
 *
 * @package    psicologia
 * @subpackage filter
 ...
 */
abstract class BaseFerr2RespuestasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ferr2_respuestas_filters[%s]');
