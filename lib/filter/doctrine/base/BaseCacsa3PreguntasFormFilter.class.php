...
/**
 * Cacsa3Preguntas filter form base class.
 *
 * @package    psicologia
 * @subpackage filter
 ...
 */
abstract class BaseCacsa3PreguntasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cacsa3_preguntas_filters[%s]');
