...
/**
 * Cacsa2Respuestas filter form base class.
 *
 * @package    psicologia
 * @subpackage filter
 ...
 */
abstract class BaseCacsa2RespuestasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cacsa2_respuestas_filters[%s]');
