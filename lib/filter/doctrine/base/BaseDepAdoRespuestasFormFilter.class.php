...
/**
 * DepAdoRespuestas filter form base class.
 *
 * @package    psicologia
 * @subpackage filter
 ...
 */
abstract class BaseDepAdoRespuestasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dep_ado_respuestas_filters[%s]');
