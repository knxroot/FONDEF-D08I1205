...
/**
 * MaciRespuestas filter form base class.
 *
 * @package    psicologia
 * @subpackage filter
 ...
 */
abstract class BaseMaciRespuestasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('maci_respuestas_filters[%s]');
