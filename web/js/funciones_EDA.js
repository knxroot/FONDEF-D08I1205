...
EDA.prototype.formTablaCruzada = function(selector) {
    ...
    .change(function(event) {        
       ...
       // alert('input[name="block'+nbloque+'-resultadoC'+ncol+'"]');
        ...
        var sumab1=parseInt($('input[name="block1-resultadoC1"]').val())+parseInt($('input[name="block1-resultadoC2"]').val())+parseInt($('input[name="block1-resultadoC3"]').val())+parseInt($('input[name="block1-resultadoC4"]').val())+parseInt($('input[name="block1-resultadoC5"]').val())+parseInt($('input[name="block1-resultadoC6"]').val())+parseInt($('input[name="block1-resultadoC7"]').val());
        $('input[name="block1-resultado"]').val(sumab1);
        var sumab2=parseInt($('input[name="block2-resultadoC1"]').val())+parseInt($('input[name="block2-resultadoC2"]').val())+parseInt($('input[name="block2-resultadoC3"]').val())+parseInt($('input[name="block2-resultadoC4"]').val())+parseInt($('input[name="block2-resultadoC5"]').val())+parseInt($('input[name="block2-resultadoC6"]').val())+parseInt($('input[name="block2-resultadoC7"]').val());
        $('input[name="block2-resultado"]').val(sumab2);
        var sumab3=parseInt($('input[name="block3-resultadoC1"]').val())+parseInt($('input[name="block3-resultadoC2"]').val())+parseInt($('input[name="block3-resultadoC3"]').val())+parseInt($('input[name="block3-resultadoC4"]').val())+parseInt($('input[name="block3-resultadoC5"]').val())+parseInt($('input[name="block3-resultadoC6"]').val())+parseInt($('input[name="block3-resultadoC7"]').val());
        $('input[name="block3-resultado"]').val(sumab3);
        /*
