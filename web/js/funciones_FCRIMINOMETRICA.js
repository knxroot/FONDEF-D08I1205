...
case '11a': 
  ...
  $('#11a').val(Math.round(($('#11asuma').val()/7)*100)/100);
  
  break;
case '11b':
    $('#11b4').val(sumar('11b4',3));    
    $('#11bsuma').val(sumar('11b',7));
    $('#11b').val(Math.round(($('#11bsuma').val()/7)*100)/100);
  break;
  case '11c':
   $('#11csuma').val(sumar('11c',5));
  $('#11c').val(Math.round(($('#11csuma').val()/5)*100)/100);
  break;
 
 case '12a':
  $('#12asuma').val(sumar('12a',3));
  $('#12a').val(Math.round(($('#12asuma').val()/3)*100)/100);
  break;
  
  case '12d':
  $('#12dsuma').val(sumar('12d',2));
  $('#12d').val(Math.round(($('#12dsuma').val()/2)*100)/100);
    break;
...
case '21a':
    ...
    $('#21a').val(Math.round(($('#21asuma').val()/4)*100)/100);
  break;

case '21b':
    $('#21b2').val(sumar('21b2',2)/2); 
    $('#21b3').val(sumar('21b3',2)/2);    	
    $('#21bsuma').val(sumar('21b',3));
    $('#21b').val(Math.round(($('#21bsuma').val()/3)*100)/100);
  break;
  
  case '21c':
  $('#21csuma').val(sumar('21c',3));
  $('#21c').val(Math.round(($('#21csuma').val()/3)*100)/100);
    break;
	
	 case '21d':
  $('#21dsuma').val(sumar('21d',4));
  $('#21d').val(Math.round(($('#21dsuma').val()/4)*100)/100);
    break;
   ...
   $('#22a4').val(sumar('22a4',2)/2);    
    ...
    $('#22a').val(Math.round(($('#22asuma').val()/4)*100)/100);
  break;
  ...
  case '22b':
   ...
   $('#22b4').val(sumar('22b4',2)/2);    
    ...
    $('#22b').val(Math.round(($('#22bsuma').val()/4)*100)/100);
  break;
    ...
    $('#22c').val(Math.round(($('#22csuma').val()/4)*100)/100);
  break;
  
    case '22d':
    $('#22dsuma').val(sumar('22d',3));
    $('#22d').val(Math.round(($('#22dsuma').val()/3)*100)/100);
  break;
...
if(el.substr(0, 2)=='11'){
	...
	if(!isNaN(aux)){
		$('#11suma').val(Math.round(aux*100)/100);
...
if(el.substr(0, 2)=='12'){
	...
	if(!isNaN(aux)){
		$('#12suma').val(Math.round(aux*100)/100);
...
if(el.substr(0, 2)=='21'){
	...
	if(!isNaN(aux)){
		$('#21suma').val(Math.round(aux*100)/100);
...
if(el.substr(0, 2)=='22'){
	...
	if(!isNaN(aux)){
		$('#22suma').val(Math.round(aux*100)/100);
...
/* SUMAS DE ABAJO*/
var cdelic=((parseFloat($('#11').val())+ parseFloat($('#12').val()))/2);
var csocial=(parseFloat(10)-((parseFloat($('#21').val())+ parseFloat($('#22').val()))/2));
