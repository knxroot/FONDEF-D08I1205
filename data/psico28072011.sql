...
--
-- Servidor: localhost
-- Tiempo de generación: 28-07-2011 a las 08:59:20
...
('Guardar', '', 2, 5, 0),
('CLOSE_FLAG', 'NOCERRADO', 2, 5, 0),
('tstart', '03:47:22', 2, 5, 0),
('module', 'DEP_ADO', 2, 5, 0),
('action', 'GuardarInstrumento', 2, 5, 0),
('idEncuestado', '5', 2, 5, 0);
...
('b1-pa', 'no_seleccionado', 2, 108, 0),
('comentario_1', '', 2, 108, 0),
('b1-pb', 'no_seleccionado', 2, 108, 0),
('comentario_2', '', 2, 108, 0),
('b1-pc', 'no_seleccionado', 2, 108, 0),
('comentario_3', '', 2, 108, 0),
('b1-pd', 'no_seleccionado', 2, 108, 0),
('comentario_4', '', 2, 108, 0),
('b1-pe', 'no_seleccionado', 2, 108, 0),
('comentario_5', '', 2, 108, 0),
('b2-pa', 'no_seleccionado', 2, 108, 0),
('comentario_6', '', 2, 108, 0),
('b2-pb', 'no_seleccionado', 2, 108, 0),
('comentario_7', '', 2, 108, 0),
('b2-pc', 'no_seleccionado', 2, 108, 0),
('comentario_8', '', 2, 108, 0),
('b2-pd', 'no_seleccionado', 2, 108, 0),
('comentario_9', '', 2, 108, 0),
('b2-pe', 'no_seleccionado', 2, 108, 0),
('comentario_10', '', 2, 108, 0),
('b2-pf', 'no_seleccionado', 2, 108, 0),
('comentario_11', '', 2, 108, 0),
('b3-pa', 'no_seleccionado', 2, 108, 0),
('comentario_12', '', 2, 108, 0),
('b3-pb', 'no_seleccionado', 2, 108, 0),
('comentario_13', '', 2, 108, 0),
('b3-pc', 'no_seleccionado', 2, 108, 0),
('comentario_14', '', 2, 108, 0),
('b3-pd', 'no_seleccionado', 2, 108, 0),
('comentario_15', '', 2, 108, 0),
('b3-pe', 'no_seleccionado', 2, 108, 0),
('comentario_16', '', 2, 108, 0),
('b3-pf', 'no_seleccionado', 2, 108, 0),
('comentario_17', '', 2, 108, 0),
('b3-pg', 'no_seleccionado', 2, 108, 0),
('comentario_18', '', 2, 108, 0),
('b4-pa', 'no_seleccionado', 2, 108, 0),
('comentario_19', '', 2, 108, 0),
('b4-pb', 'no_seleccionado', 2, 108, 0),
('comentario_20', '', 2, 108, 0),
('b4-pc', 'no_seleccionado', 2, 108, 0),
('comentario_21', '', 2, 108, 0),
('b4-pd', 'no_seleccionado', 2, 108, 0),
('comentario_22', '', 2, 108, 0),
('b5-pa', 'no_seleccionado', 2, 108, 0),
('comentario_23', '', 2, 108, 0),
('b5-pb', 'no_seleccionado', 2, 108, 0),
('comentario_24', '', 2, 108, 0),
('b5-pc', 'no_seleccionado', 2, 108, 0),
('comentario_25', '', 2, 108, 0),
('b5-pd', 'no_seleccionado', 2, 108, 0),
('comentario_26', '', 2, 108, 0),
('b5-pe', 'no_seleccionado', 2, 108, 0),
('comentario_27', '', 2, 108, 0),
('b6-pa', 'no_seleccionado', 2, 108, 0),
('comentario_28', '', 2, 108, 0),
('b6-pb', 'no_seleccionado', 2, 108, 0),
('comentario_29', '', 2, 108, 0),
('b6-pc', 'no_seleccionado', 2, 108, 0),
('comentario_30', '', 2, 108, 0),
('b7-pa', 'no_seleccionado', 2, 108, 0),
('comentario_31', '', 2, 108, 0),
('b7-pb', 'no_seleccionado', 2, 108, 0),
('comentario_32', '', 2, 108, 0),
('b7-pc', 'no_seleccionado', 2, 108, 0),
('comentario_33', '', 2, 108, 0),
('b7-pd', 'no_seleccionado', 2, 108, 0),
('comentario_34', '', 2, 108, 0),
('b7-pe', 'no_seleccionado', 2, 108, 0),
('comentario_35', '', 2, 108, 0),
('b7-pf', 'no_seleccionado', 2, 108, 0),
('comentario_36', '', 2, 108, 0),
('b7-pg', 'no_seleccionado', 2, 108, 0),
('comentario_37', '', 2, 108, 0),
('b8-pa', 'no_seleccionado', 2, 108, 0),
('comentario_38', '', 2, 108, 0),
('b8-pb', 'no_seleccionado', 2, 108, 0),
('comentario_39', '', 2, 108, 0),
('b8-pc', 'no_seleccionado', 2, 108, 0),
('comentario_40', '', 2, 108, 0),
('b8-pd', 'no_seleccionado', 2, 108, 0),
('comentario_41', '', 2, 108, 0),
('b8-pe', 'no_seleccionado', 2, 108, 0),
('comentario_42', '', 2, 108, 0),
('b9p1', 'no', 2, 108, 0),
('b9p2', 'no', 2, 108, 0),
('b9p3', 'no', 2, 108, 0),
('b9p4', 'no', 2, 108, 0),
...
INSERT INTO `modo_respuesta` (`modo`, `nombre_modulo`, `id_user`, `id_encuestado`) VALUES
('modo1', 'CACSA', 2, 5),
('modo3', 'CAIE', 2, 5),
('modo3', 'CONCLUSIONES', 2, 5),
('modo1', 'CSVE', 2, 5),
('modo3', 'DEP_ADO', 2, 5),
('Autoreporte acompañado', 'EDA', 2, 5),
('modo3', 'ENTREVISTA', 2, 5),
('modo1', 'JIR', 2, 5),
('modo3', 'MACI', 2, 5),
('modo3', 'SQIFA', 2, 5);
...
(2, 'Paula Andrea', 'Alarcón Bañares', 'john.doe@gmail.com', 'admini', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-28 08:28:39', '2010-10-19 01:48:58', '2011-07-28 08:28:39'),
...
(5, 'Pedro Manuel', 'Abelardo Torres', 'pedro@lacosox.org', '220536866', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:31:00', '2010-10-19 01:48:58', '2011-07-27 08:31:00'),
(6, 'Georg Wilhelm', 'Hegel Z', 'gustavow@lacosox.org', '69147569', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:28:37', '2011-05-06 03:02:41', '2011-07-27 08:28:37'),
(7, 'Gottfried Wilhelm', 'Leibniz', 'gootfriend@lacosox.org', '119498562', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 0, '2011-07-02 04:13:02', '0000-00-00 00:00:00', '2011-07-02 04:13:02'),
(8, 'Georg Wilhelm', 'Hegel Z', 'georg@lacosox.org', '166209692', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:28:37', '2011-05-06 03:02:41', '2011-07-27 08:28:37'),
(9, 'Alfredo  Bateman', 'Cardenas Z', 'AlfredoJBateman@example.com', '7461678k', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:28:37', '2011-05-06 03:02:41', '2011-07-27 08:28:37'),
(10, 'Gregory A', 'Cardenas A', 'gustavoa@lacosox.org', '13760213k', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:28:37', '2011-05-06 03:02:41', '2011-07-27 08:28:37'),
(11, 'Andres Alejandro', 'Valenzuela Concha', 'aalejandro@lacosox.org', '110396600', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:28:37', '2011-05-06 03:02:41', '2011-07-27 08:28:37'),
(12, 'Claudia Patricia', 'Avendaño', 'cav@lacosox.org', '6898596k', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-27 08:28:37', '2011-05-06 03:02:41', '2011-07-27 08:28:37');
