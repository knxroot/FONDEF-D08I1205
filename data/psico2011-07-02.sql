...
--
-- Servidor: localhost
-- Tiempo de generación: 02-07-2011 a las 06:00:14
...
INSERT INTO `csve_respuestas` (`id_user`, `respuesta`, `respuesta2`, `respuesta3`, `comentario`, `id_encuestado`, `id_pregunta_CSVE`) VALUES
(2, 'si', 0, 'no', '', 13, 10),
(2, 'no', 0, 'no', '', 13, 18),
(2, 'si', 0, 'no', '', 108, 1),
(2, 'no', 0, 'no', '', 108, 2),
...
(108, 2, 3, NULL, '345345345', 'qweqwe', 'qqwe', 'qweqwe', 'qweqwe', 'on', '0000-00-00 00:00:00', '1', '14', '1401', 'on', '123123', 'Pascuense', 'Menos de $150.000', 'Ambos Padres', 'Si', '1º Básico', '2000', '1º Básico', 'Termino enseñanza media completa', 'No', 'Programa Ambulatorio Intensivo', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', ''),
...
CREATE TABLE IF NOT EXISTS `encuestado_actinputado` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `input_fecha_inicio_investigacion3` datetime NOT NULL,
  `input_plazo_investigacion3` datetime NOT NULL,
  `select_tribunal3` varchar(254) NOT NULL,
  `select_tipo_materia3` varchar(255) NOT NULL,
  `select_causa_delito3` varchar(255) NOT NULL,
  `id_encuestado` bigint(20) NOT NULL,
  `input_ruk_3` varchar(254) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_encuestado` (`id_encuestado`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(2, 'F', '', 108, 16),
(2, 'F', '', 108, 17),
(2, 'F', '123123123', 108, 18),
(2, 'F', '', 108, 19),
(2, 'F', '', 108, 20),
(2, 'F', 'el miguel es suppeeeeer bkn', 108, 21),
(2, 'V', '', 108, 22),
(2, 'F', '', 108, 23),
(2, 'F', '', 108, 24),
(2, 'F', '', 108, 25),
...
(2, 'Paula Andrea', 'Alarcón Bañares', 'john.doe@gmail.com', 'admini', 'sha1', 'af10c4c7f920e09cd5c7ec984a84408d', '7777a8289bf7f5c327ff38f4144e48d74047290f', 1, 1, '2011-07-02 04:13:48', '2010-10-19 01:48:58', '2011-07-02 04:13:48'),
